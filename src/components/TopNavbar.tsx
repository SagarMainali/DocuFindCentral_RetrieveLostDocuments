...
export default function TopNavbar() {
     ...
     return (
          <header className={`flex justify-between items-center h-[60px] px-6 drop-shadow-[0_10px_15px_rgba(0,0,0,0.25)] duration-200
          ${isLight ? 'lightmode' : 'darkmode'}`}>
               ...
               <div className="nav-right flex items-center gap-6">
                    <span onClick={() => dispatch(changeLanguage())} className="cursor-pointer">
                         {isEnglish
                              ...
                              <span className="flex items-center gap-1">
                                   ...
                                   <h2 className="text-white text-[14px] tracking-wide">NEP</h2>
                              </span>
                              :
                              <span className="flex items-center gap-1">
                    ...
                    <span onClick={() => dispatch(changeTheme())} className="cursor-pointer">
                         {isLight
                              ?
                              <svg className="fill-white" xmlns="http://www.w3.org/2000/svg" width="1.1rem" viewBox="0 0 16 16">
