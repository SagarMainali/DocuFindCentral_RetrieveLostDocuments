...
export default function TopNavbar() {
     return (
          <header className="flex justify-between items-center h-[50px] bg-[#333A56] px-4">
               ...
               <span className="nav-right flex items-center gap-6">
                    <span className="flex items-center gap-1 cursor-pointer">
                         ...
                         <h2 className="text-slate-50 text-[14px]">NEP</h2>
                    </span>
                    ...
                    <svg className="fill-slate-50 cursor-pointer" xmlns="http://www.w3.org/2000/svg" height="1.1rem" viewBox="0 0 16 16">
