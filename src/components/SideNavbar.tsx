...
export default function SideNavbar() {
     ...
     return (
          ...
          max-md:absolute z-50 ${isMenuOpened ? 'w-[250px]' : 'md:w-[65px] w-0'}`}>
               ...
               <div className="text-slate-50 flex flex-col gap-2">
                    ...
                    <NavLink to="/feedback"
                         className={({ isActive }) => `navlink flex gap-2 items-center pl-[18px] 
                         ${isMenuOpened ? '' : 'icon-center'}
                         ${isActive ? 'navlink-active' : ''}`}>
                    ...
                    <NavLink to="/about-us"
                         className={({ isActive }) => `navlink flex gap-2 items-center pl-[20px] 
                         ${isMenuOpened ? '' : 'icon-center'}
                         ${isActive ? 'navlink-active' : ''}`}>
